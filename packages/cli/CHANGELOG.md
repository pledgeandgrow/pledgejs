...
- b79ea85: Fix `window.__PLEDGE_ROUTE__` emitting empty `params` — the React renderer's
...
- b79ea85: Removed the Rollup, Turbopack, Rsbuild and Webpack bundler adapters.
...
- Updated dependencies [b79ea85]
  - create-pledge-app@0.1.9
